package com.eatthepath.pushy.apns.jtonic.selfsigned;
...
public class MockApnsServerApp {
  ...
  protected static final String SERVER_CERTIFICATES_FILENAME = "/jtonic/ca/server-certs.pem";
  protected static final String SERVER_KEY_FILENAME = "/jtonic/ca/server-key.pem";
  protected static final String CA_CERTIFICATE_FILENAME = "/jtonic/ca/ca.pem";
