...
public class ApnsClientApp {
  ...
  private static final String CLIENT_CERTIFICATES_FILENAME = "/jtonic/ca/multi-topic-client.p12";
  private static final String CA_CERTIFICATE_FILENAME = "/jtonic/ca/ca.pem";
